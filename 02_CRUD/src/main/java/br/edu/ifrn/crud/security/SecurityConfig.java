...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	//RESPONSAVEL PELA CONFIG DE AUTENTICA��O E AUTORIZA��O
	@Override
	protected void configure(HttpSecurity http) throws Exception {
		...
		*/
		...
		http.authorizeRequests()
			...
			.and() //ADICIONAR OUTRA CONDI��O(OP�OES)
				.formLogin()
			...
			.and()
				.logout()
				.logoutUrl("/logout") //URL PASSADA NO FORM DA PAGINA INICIO.HTML (LOGOUT � FEITO AUTOMATICAMETE PELO THYMELEAF)
