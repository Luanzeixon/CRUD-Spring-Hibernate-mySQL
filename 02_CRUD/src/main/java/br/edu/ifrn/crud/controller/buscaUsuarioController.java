...
public class buscaUsuarioController {
	...
	@GetMapping("/buscar")
	public String buscar(@RequestParam(name = "nome", required = false) String nome, // pegar valor da url cujo o nome
																						// é "nome" e atribuir a uma
																						// String nome
			@RequestParam(name = "email", required = false) String email,
			@RequestParam(name = "mostrarTodosDados", required = false) Boolean mostrarTodosDados, ModelMap model
	// required = false: para que seja opcional a informacao do parametro, se nao
	// tiver isso da erro se nao informar
	) {
